...
class CsvReader(object):
    ...
    def create_from_csv(csv_path, sep=";"):
        data_read = CsvReader.read_from_file(csv_path)
        unprocessed_data = CsvReader.create_data_frame_from_read_data(data_read, sep=sep)
    ...
    @staticmethod
    def create_data_frame_from_read_data(read_lines, sep=";"):
